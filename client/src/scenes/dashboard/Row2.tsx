...
import { CartesianGrid, Line, LineChart, ResponsiveContainer, XAxis, YAxis, Tooltip, PieChart, Pie, Cell, Scatter, ZAxis, ScatterChart } from 'recharts'
...
const Row2 = () => {
  ...
  const pieColors = [palette.tertiary[500], palette.tertiary[800]];
  ...
  return (
    <>
        <DashboardBox bgcolor="	#0A0705" gridArea="d">
        <BoxHeader
        ...
        <DashboardBox bgcolor="	#0A0705" gridArea="e">
      ...
      <DashboardBox bgcolor="	#0A0705" gridArea="f">
      <BoxHeader title="Product Prices vs Expenses" sideText="+4%" />
        <ResponsiveContainer width="100%" height="100%">
          ...
          >
            ...
            <ZAxis type="number" range={[20]} />    {/* changing the size of points */}
